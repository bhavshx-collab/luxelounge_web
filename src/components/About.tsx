...
export default function About() {
  ...
  return (
    <section id="about" className="py-28 bg-[#111111] overflow-hidden">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              {values.map((v, i) => (
                <div key={v.title} className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="font-playfair text-[1rem] text-[#f8f5f0] font-semibold">{v.title} — </span>
                    <span className="font-inter text-[0.85rem] text-[rgba(248,245,240,0.55)]">{v.desc}</span>
                  </div>
                </div>
              ))}
            </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 glass p-6 bg-[rgba(17,17,17,0.9)]"
            >
              <div className="font-playfair text-4xl font-bold text-[#d4af37]">4.9</div>
              <div className="stars text-sm mt-1">★★★★★</div>
              <div className="font-inter text-[0.7rem] tracking-[0.2em] uppercase text-[rgba(248,245,240,0.5)] mt-2">
                Client Rating
              </div>
            </motion.div>

            {/* Gold border accent */}
            <div className="absolute -top-3 -right-3 w-24 h-24 border-t border-r border-[rgba(212,175,55,0.4)]" />
            <div className="absolute -bottom-3 -left-3 w-24 h-24 border-b border-l border-[rgba(212,175,55,0.4)]" />
          </motion.div>
        </div>
      </div>
    </section>
